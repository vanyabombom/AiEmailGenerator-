...
import { Mail, Lock, ArrowRight, ShieldAlert, Zap } from "lucide-react";
...
export default function LoginPage() {
  ...
  const { signIn, signInWithGoogle, isMockMode, fillDemoCredentials } = useAuth();
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (isMockMode) {
        toast.success("Signed in with Google (Demo)! Redirecting...");
        ...
        <Card className="w-full max-w-md glass-panel relative z-10">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription className="text-slate-600 dark:text-slate-400">
              Sign in to generate high-converting AI emails
            </CardDescription>
